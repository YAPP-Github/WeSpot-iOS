//
//  ProfileCharacterCollectionViewCell.swift
//  AllFeature
//
...
final class ProfileCharacterCollectionViewCell: UICollectionViewCell {
    //MARK: - Properties
...
extension ProfileCharacterCollectionViewCell: ReactorKit.View {
    
    func bind(reactor: ProfileCharacterCellReactor) {
